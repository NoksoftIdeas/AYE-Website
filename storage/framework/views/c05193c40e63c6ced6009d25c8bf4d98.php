    ...
    <div style="background-color: white; padding: 30px; border-radius: 0 0 8px 8px;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td style="padding: 10px 0; border-bottom: 1px solid #eee;"><?php echo e($submission->name); ?></td>
            </tr>
            <tr>
                <td style="padding: 10px 0; border-bottom: 1px solid #eee;"><strong>Email:</strong></td>
                <td style="padding: 10px 0; border-bottom: 1px solid #eee;">
                    <a href="mailto:<?php echo e($submission->email); ?>" style="color: #2FA4A9;"><?php echo e($submission->email); ?></a>
                </td>
            </tr>
            <?php if($submission->phone): ?>
            <tr>
                <td style="padding: 10px 0; border-bottom: 1px solid #eee;"><strong>Phone:</strong></td>
                <td style="padding: 10px 0; border-bottom: 1px solid #eee;"><?php echo e($submission->phone); ?></td>
            </tr>
            <?php endif; ?>
            <?php if($submission->subject): ?>
            <tr>
                <td style="padding: 10px 0; border-bottom: 1px solid #eee;"><strong>Subject:</strong></td>
                <td style="padding: 10px 0; border-bottom: 1px solid #eee;"><?php echo e($submission->subject); ?></td>
            </tr>
            <?php endif; ?>
            <tr>
                <td style="padding: 10px 0; border-bottom: 1px solid #eee;"><strong>Submitted:</strong></td>
                <td style="padding: 10px 0; border-bottom: 1px solid #eee;"><?php echo e($submission->created_at->format('F j, Y \a\t g:i A')); ?></td>
            </tr>
        </table>
        ...
        <div style="background-color: #f9f9f9; padding: 15px; border-left: 4px solid #2FA4A9; border-radius: 4px;">
            <p style="margin: 0; line-height: 1.6; white-space: pre-wrap;"><?php echo e($submission->message); ?></p>
        </div>
        
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee; text-align: center; color: #666; font-size: 12px;">
            <p>This email was sent from the Aye Sickle Cell Foundation contact form.</p>
            <p>IP Address: <?php echo e($submission->ip_address); ?></p>
        </div>
    </div>
</div>
<?php /**PATH C:\Users\Noksoft Ideas\Documents\Projects\AYE\resources\views/emails/contact-form.blade.php ENDPATH**/ ?>