...
<?php $__env->startSection('title', 'Home - Aye Sickle Cell Foundation'); ?>
<?php $__env->startSection('meta_description', 'Aye Sickle Cell Foundation is dedicated to improving the quality of life for individuals living with sickle cell disease through awareness, advocacy, and support services.'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div class="animate-on-scroll">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="<?php echo e(route('education')); ?>" class="btn btn-accent">Learn About Sickle Cell</a>
                    <a href="<?php echo e(route('support')); ?>" class="btn btn-outline bg-white/10 text-white border-white hover:bg-white hover:text-primary">Get Support</a>
                </div>
            </div>
    ...
    <div class="container-custom">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="card animate-on-scroll">
                ...
                <a href="<?php echo e(route('education')); ?>" class="text-primary font-semibold hover:text-primary-700 transition">
                    Learn More →
                </a>
            </div>
            ...
            <div class="card animate-on-scroll">
                ...
                <a href="<?php echo e(route('education')); ?>" class="text-secondary font-semibold hover:text-secondary-700 transition">
                    Learn More →
                </a>
            </div>
            ...
            <div class="card animate-on-scroll">
                ...
                <a href="<?php echo e(route('support')); ?>" class="text-accent-700 font-semibold hover:text-accent-800 transition">
                    Get Support →
                </a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg animate-on-scroll">
                <div class="flex items-center mb-4">
                    ...
                    <img src="<?php echo e(asset('storage/' . $testimonial->image)); ?>" alt="<?php echo e($testimonial->name); ?>" class="w-16 h-16 rounded-full object-cover mr-4">
                    <?php else: ?>
                    ...
                    <?php endif; ?>
                    <div>
                        <div class="font-semibold"><?php echo e($testimonial->name); ?></div>
                        <?php if($testimonial->role): ?>
                        <div class="text-sm text-gray-600"><?php echo e($testimonial->role); ?></div>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <div class="container-custom text-center">
        <div class="max-w-3xl mx-auto animate-on-scroll">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="<?php echo e(route('get-involved')); ?>" class="btn btn-accent">Volunteer With Us</a>
                <a href="<?php echo e(route('contact')); ?>" class="btn bg-white text-primary hover:bg-gray-100">Contact Us</a>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Noksoft Ideas\Documents\Projects\AYE\resources\views/home.blade.php ENDPATH**/ ?>