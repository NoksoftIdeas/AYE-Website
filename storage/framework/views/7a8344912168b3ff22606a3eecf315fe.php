...
<?php $__env->startSection('title', 'Advocacy & Awareness - Aye Sickle Cell Foundation'); ?>
<?php $__env->startSection('meta_description', 'Join our advocacy efforts to improve policies, increase awareness, and create better outcomes for people living with sickle cell disease.'); ?>
    ...
    <div class="container-custom text-center">
        <div class="max-w-3xl mx-auto animate-on-scroll">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="<?php echo e(route('get-involved')); ?>" class="btn btn-accent">Get Involved</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Noksoft Ideas\Documents\Projects\AYE\resources\views/advocacy.blade.php ENDPATH**/ ?>