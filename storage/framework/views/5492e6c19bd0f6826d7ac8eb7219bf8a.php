    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="<?php echo e(request()->routeIs('admin.contacts') ? 'mm-active' : ''); ?>">
                        <a href="<?php echo e(route('admin.contacts')); ?>" aria-expanded="false">
                            <i class="flaticon-381-network"></i>
                            <span class="nav-text">Contact Submissions</span>
                        </a>
                    </li>
                    <li class="<?php echo e(request()->routeIs('admin.volunteers') ? 'mm-active' : ''); ?>">
                        <a href="<?php echo e(route('admin.volunteers')); ?>" aria-expanded="false">
                    ...
                    <li>
                        <a href="<?php echo e(route('home')); ?>" target="_blank" aria-expanded="false">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © <?php echo e(date('Y')); ?> AYE Sickle Cell Foundation. All Rights Reserved.</p>
            </div>
        </div>
        <!--**********************************
            Footer end
...
<?php /**PATH C:\Users\Noksoft Ideas\Documents\Projects\AYE\resources\views/layouts/admin.blade.php ENDPATH**/ ?>